...
대화만 하면서도 학습 내용이 흘러가 버리지 않도록 만드는 범용 Agent Skill입니다.

짧게 설명하고, 학습자가 자기 말로 회상하게 하고, 틀린 부분을 교정한 뒤, 다음 복습일과 최소 기억 기록을 남깁니다. 네트워크, AI, 데이터센터, 영어, AX뿐 아니라 대부분의 학습 주제에 사용할 수 있습니다.
